...
struct C610
{
    static constexpr int16_t current_limit = 10000; // -10000 to 10000
    static constexpr int16_t angle_max = 8192;      // C610の最大角度
    static constexpr float angle_divisor = 146.5f;  // 角度換算用
